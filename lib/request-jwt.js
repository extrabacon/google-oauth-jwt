 ...
 *
 * @param {Object} tokens The TokenCache instance to use. If not specified, a global cache will be used.
...
exports.requestWithJWT = function (tokens, request) {
	...
	return function (uri, options, callback) {
		...
		var tokenCache = tokens || TokenCache.global;
		...
		if (options.jwt) {
			return tokenCache.get(options.jwt, function (err, token) {
