...
exports.requestWithJWT = function (tokens, request) {
	...
	var interceptor = function (fn) {
		return function (uri, options, callback) {
			...
			if (params.options.jwt) {
				return tokens.get(params.options.jwt, function (err, token) {
					...
					fn(params.uri || null, params.options, params.callback);
				});
			} else {
				return fn(params.uri || null, params.options, params.callback);
			}
		};
	};
